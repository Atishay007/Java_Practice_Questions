...
//it uses O(n) space and O(n) time complexity.
public class RepeatAndMissingNoArray {

	public static void main(String[] args) {
		List<Integer> lst = Arrays.asList(389, 299, 65, 518, 361, 103, 342, 406, 24, 79, 192, 181, 178, 205, 38, 298,
				218, 143, 446, 324, 82, 41, 312, 166, 252, 59, 91, 6, 248, 395, 157, 332, 352, 57, 106, 246, 506, 261,
				16, 470, 224, 228, 286, 121, 193, 241, 203, 36, 264, 234, 386, 471, 225, 466, 81, 58, 253, 468, 31, 197,
				15, 282, 334, 171, 358, 209, 213, 158, 355, 243, 75, 411, 43, 485, 291, 270, 25, 100, 194, 476, 70, 402,
		...
		int[] countArr = new int[lst.size() + 1];
		List<Integer> finalLst = new ArrayList<>();

		for (int i = 0; i < lst.size(); i++) {
			if (countArr[lst.get(i)] == 1) {
		...
		finalLst.add(getMissingNo(lst, lst.size()));
		System.out.println(finalLst);
	}

	// Best solution using XOR to find missing no.
	static int getMissingNo(List<Integer> lst, int n) {
		int x1 = lst.get(0);
		int x2 = 1;
